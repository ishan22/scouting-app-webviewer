...
module.exports = React.createClass({
    ...
    render: function(){
        var specialInfo = (this.state.data_type !== 'location')?
        (<div>
        ...
        return(
            <div>
                <Button bsStyle="primary" onClick={this.showModal}>New</Button>
                <Modal show={this.state.showModal} onHide={this.closeModal}>
                    ...
                    <Modal.Body>
                        <Tabs defaultActiveKey={this.state.data_type} activeKey={this.state.data_type} onSelect={this.tabSelected}>
                           ...
                           <Tab eventKey="stock" title="Stock" dsabled={!this.state.allow_stock}></Tab>
                         </Tabs>
